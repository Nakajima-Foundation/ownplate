      ...
      <div class="flex w-full justify-center">
		...
		<div class="m-4 rounded-lg bg-white sm:max-w-5xl lg:mx-auto border-2 border-[#0068B7]">
			<div class="text-center bg-[#0068B7] text-white font-bold py-1">
				{{ $t("mobileOrder.campaign.part2") }}
			</div>
			<div class="text-black py-3 font-bold px-5">
				<div class="text-sm sm:text-base text-center">{{ $t("mobileOrder.campaign.period2") }}</div>
				<div class="text-sm sm:text-base text-center">{{ $t("mobileOrder.campaign.receivingPeriod2") }}</div>
