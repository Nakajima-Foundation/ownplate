const data = [
  ...
  {
    title: "v3.0.8 をリリースしました。",
    date: "2025-11-29",
    markdown:
      "## v3.0.8 (2025/11/30)\n\n- 管理系\n  - ２要素認証のログインに対応しました\n",
  },
  {
    title: "v3.0.7 をリリースしました。",
    date: "2025-01-23",
    markdown:
  ...
  {
    title: "v2.0.11をリリースしました。",
    date: "2021-07-14",
    markdown:
      "## v2.0.11 (2021/07/14)\n\n- ユーザ系\n  - 都道府県別、運営者別の飲食店一覧ページに地図でお店を表示するようにしました。\n  - 訪日客のSMS認証に対応しました。\n\n  \n",
  },
  {
    title: "v2.0.10をリリースしました。",
    date: "2021-06-22",
    markdown:
      "## v2.0.10 (2021/06/22)\n\n- ユーザ系\n  - 削除済みの「商品グループ名」がメニューに表示される問題の修正\n  - カバー画像の変更\n  \n",
  },
  {
    title: "v2.0.9をリリースしました。",
    date: "2021-06-12",
    markdown:
      "## v2.0.9 (2021/06/12)\n\n- 管理系\n  - サブアカウント機能を追加しました。\n",
  },
  {
    title: "v2.0.8をリリースしました。",
    date: "2021-05-19",
    markdown:
      "## v2.0.8 (2021/05/19)\n\n- 管理系\n  - 運営している全ての飲食店の注文を確認できるページを追加しました\n- ユーザー系\n  - 飲食店一覧を名前順に並ぶようにしました\n  - エリアの都道府県を更新しました\n",
  },
  {
    title: "v2.0.7をリリースしました。",
    date: "2021-05-06",
    markdown:
  ...
  {
    title: "v0.5.4をリリースしました。",
    date: "2020-06-10",
    markdown:
      "  - 管理系\n    - 管理系の更新情報をお知らせ機能追加\n    - 新しい注文が入ったことをLINEのメッセージとして受け取る機能\n    - 営業時間保存でエラーになる問題の修正\n    - sitemapの追加\n  - ユーザ系\n    - 都道府県別の飲食店リストページ追加\n\n   \n",
  },
  {
    title: "v0.5.2をリリースしました。",
    date: "2020-06-08",
    markdown:
