            ...
            <div class="level">
              ...
              <div class="level-left flex-1">
                ...
                <!-- <div class="is-inline-flex flex-center m-t-24">
                  <div>
                    <img :src="restaurantInfo.restProfilePhoto" class="w-8 h-8 r-36 cover" />
                  </div>
                  <div
            ...
            <div v-if="!existsMenu || menuCounter > 5">
              ...
              >
                ...
                <div class="align-center">
                  <b-button
                    class="b-reset op-button-pill h-10 bg-form m-r-8 m-l-8 m-t-16"
                    :disabled="submitting"
                    @click="addTitle('top')"
                  >
                  ...
                  <b-button
                    class="b-reset op-button-pill h-10 bg-form m-l-8 m-r-8 m-t-16"
                    :disabled="submitting"
                    @click="addMenu('top')"
                  >
                    <i class="material-icons c-primary m-l-8">add</i>
