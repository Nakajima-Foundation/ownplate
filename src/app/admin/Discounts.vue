<template>
  <div class="mx-6 mt-6">
    ...
    <div v-for="(promotion, k) in promotionDataSet">
      名前: <router-link :to="isInMo ? `/admin/discounts/${promotion.promotionId}` : `/admin/restaurants/${shopInfo.restaurants}/discounts/${promotion.promotionId}`">{{ promotion.promotionName }}</router-link><br/>
