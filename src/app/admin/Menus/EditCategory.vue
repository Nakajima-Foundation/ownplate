<template>
  <b-modal :active.sync="isVisible" :width="488">
    <div class="op-dialog p-t-24 p-l-24 p-r-24 p-b-24">
      <div
        style="height:16em;overflow-y:scroll;border:1px #ccc solid;border-radius:4px"
      >
        <div
          class="p-l-4 p-r-4"
        ...
        >
          ...
          <b-button class="b-reset h-10 m-l-8" @click="handleDelete(index)">
      ...
      <div class="cols m-t-16">
        ...
        <b-button
          ...
          class="b-reset m-l-8 op-button-pill h-10 bg-form"
          @click="handleAdd"
        >
