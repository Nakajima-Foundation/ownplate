<template>
  <section class="section">
    <div class="card block">
      <form class="card-content" @submit.prevent="handleNext">
        <h2 class="p-big bold">{{ $t('admin.passwordReset') }}</h2>
        ...
        <p v-if="emailSent" style="margin-top:1rem">{{$t('admin.pleaseCheckInbox')}}</p>
      </form>
    </div>
  </section>
</template>
