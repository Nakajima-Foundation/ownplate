...
export default defineComponent({
  setup() {
    const faqList = [
      ...
      {
        q: "各種サービスについて",
        answers: ["モバイルオーダーでは以下のサービスをご利用いただけます。"],
        type1: ["【本日受け取る】"],
        answers1: [
      ...
      },
      {
        ...
        answers: [
          "販売されている価格はモバイルオーダーの価格となり、店頭価格と異なる場合がございます。",
        ],
        notes: [
      ...
      },
      {
        ...
        answers2: [
          ...
          "その場合、ご登録いただきました電話番号にSMS（ショートメッセージサービス）にて「お客様ご自身にてキャンセルされたか、商品のご用意ができなかった為、ご注文がキャンセルされました。」というメッセージが配信されます。",
        ],
      },
      {
        q: "ご注文商品の返品について",
