          ...
          <div class="m-l-24 m-r-24">
            ...
            <div class="bg-surface r-8 d-low m-t-24 p-t-24 p-b-24">
              <div class="align-center">
                <i class="material-icons c-text-black-disabled s-96">store</i>
                <!-- Go to Owner Page -->
            ...
            <div class="bg-surface r-8 d-low m-t-24 p-t-24 p-b-24">
              <div class="align-center">
                <i class="material-icons c-text-black-disabled s-96"
                  >tag_faces</i
                >
                <!-- Go to User Page -->
            ...
            <!-- For Super Admin -->
            <div
              class="bg-surface r-8 d-low m-t-24 p-t-24 p-b-24"
          ...
          <div class="m-l-24 m-r-24">
            ...
            <div v-if="!isLocaleJapan">
              ...
              <div class="t-body1 c-text-black-high m-t-24">
                The COVID-19 has not only claimed the lives of many people, but
                it has also caused significant damage to the economy. In
              ...
              <div class="t-body1 c-text-black-high m-t-24">
                We've created {{ $t("serviceName." + this.serviceKey) }} to help
                ...
                dedicated pages and register menu items there (no special skill
                is required), where customers can order and pay, then pick them
                up at restaurants.
              </div>
              <div class="t-body1 c-text-black-high m-t-24">
                We, Singularity Society, is a non-profit organization, consists
                of software engineers, designers and business people. We are
                building {{ $t("serviceName." + this.serviceKey) }} with
                Firebase (Google) + Vue (open source), which allows us to
                develop this service in a very short period of time.
              </div>
