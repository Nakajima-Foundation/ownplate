      ...
      <div class="columns is-gapless">
        ...
        <div class="column">
          <div class="m-l-24 m-r-24">
                ...
                <div class="align-center m-t-16">
                  <router-link to="/admin/restaurants">
                    <div class="op-button-medium primary" style="min-width: 288px;">
                      <span class="c-onprimary p-l-24 p-r-24">{{$t("menu.admins")}}</span>
                    </div>
                  </router-link>
                </div>
                <!-- Go to Owner Manual -->
                <div class="align-center m-t-16" v-if="isJapan">
                  ...
                  >
                    <div class="op-button-small secondary" style="min-width: 256px;">
                      <span class="c-primary p-l-24 p-r-24">{{$t("menu.adminManual")}}</span>
                    </div>
                  </a>
                </div>
              </div>
            ...
            <div class="bg-surface r-8 d-low m-t-24 p-t-24 p-b-24">
              <div class="align-center">
                ...
                <div class="align-center m-t-16">
                  ...
                  >
                    <div class="op-button-small secondary" style="min-width: 256px;">
                      <span class="c-primary p-l-24 p-r-24">{{$t("menu.userManual")}}</span>
                    </div>
                  </a>
                </div>
              </div>
            ...
            >
              <div class="align-center">
                <i class="material-icons c-text-black-disabled s-96">analytics</i>
                <!-- Go to Super Admin Page -->
                <div class="align-center m-t-16">
                  <router-link to="/s">
                    <div class="op-button-medium primary" style="min-width: 288px;">
                      <span class="c-onprimary p-l-24 p-r-24">Super Admin Page</span>
                    </div>
                  </router-link>
                </div>
              </div>
          ...
          <div class="m-l-24 m-r-24">
            ...
            <div v-if="!isLocaleJapan">
              ...
              <div class="t-body1 c-text-black-high m-t-24">
                ...
                but it has also caused significant damage to the economy.
                In particular, restaurants and bars that offer "places for people to gather" have suffered directly
                from lockdown and shelter-in-place measures.
                At the result, millions of people were layed off,
            ...
            <!-- Japanese -->
            <div v-else>
              <div class="t-h6 c-text-black-disabled m-t-24">このサービスについて</div>
              <div class="t-body1 c-text-black-high m-t-24">
