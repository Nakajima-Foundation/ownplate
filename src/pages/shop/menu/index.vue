    ...
    <section class="section">
      ...
      <b-tabs size="is-medium" class="block" expanded>
        ...
        <b-tab-item label="About">
          ...
          <a target="_blank" href="https://goo.gl/maps/g1ocnE21MTvbeTaV7" class="p-font-middle"><i class="fas fa-map-marker-alt" style="margin-right:1rem;"></i>5401 20th Ave NW, Seattle, WA 98107</a>
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10747.343129628855!2d-122.3823014!3d47.6681865!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x77579f8814f54e37!2sArashi%20Ramen!5e0!3m2!1sja!2sjp!4v1584711520886!5m2!1sja!2sjp" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>

          <h2 class="bold">Phones Number</h2>
          <div class="notification is-centered">
            <a><p class="p-font bold" style="text-align:center;">+1 206-492-7933</p></a>
          </div>
          <h2 class="bold">Website</h2>
          <div class="notification">
            <div class="is-centered" style="margin-left: 2rem;margin-right: 2rem;"><a target="_blank" href="https://www.arashiramen.com/">https://www.arashiramen.com/</a></div>
          </div>
        </b-tab-item>
      </b-tabs>
      <button @click="checkOut" id="order_btn" class="button is-info is-rounded" v-if="0 != footCounter">
