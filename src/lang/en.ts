const data = {
  ...
  "mobileOrder": {
    ...
    "closing": {
      "notice": "Notice",
			...
			"paragraph1": "Thank you for your continuous support. Mobile Order will no longer be available on Friday, August 18, 2023. We apologize for any inconvenience and appreciate your understanding.",
			"paragraph2": "Please check below for the schedule until the end of the service.",
			...
			"closedParagraph": "Thank you for your continuous support. Mobile Order is no longer available on Friday, August 18, 2023. We apologize for any inconvenience and appreciate your understanding."
    }
  },
  "profile": {
    "title": "My Page",
  ...
  "editRestaurant": {
    ...
    "moveToLineConfig": "Go to the LINE notification settings screen. Don't forget to save this page before moving.",
    "openDaysConfig": "Business date and time setting",
    "lunchOrDinnerToggle": "Automatic lunch/dinner switch",
    "lunchOrDinnerNotice": "Be sure to enter two business hours for each business day. The top is for lunch, and the bottom (another time slot (optional)) is for dinner.",
  ...
  "transactionsAct": {
    ...
    "otherFeesDescriptionDelivery": "A shipping fee will be charged separately. Please check the page of each store for the shipping fee.",
  ...
  "lp": {
    ...
    "moTagline": "FamilyMart's official layaway service that allows you to easily make purchases from your PC or smartphone.",
    "moDescription1": "You can order products that we do not normally carry.",
    "moDescription2": "You can pick up your order at the store in an hour at the earliest.",
  ...
  "order": {
    ...
    "orderErrorMessage": "The order could not be processed. The item may have been sold out in the cart. Please go back to the page and place your order again.",
  ...
  "admin": {
    ...
    "order": {
      ...
      "notSuspendAvailable": "Business hours are over for today, so you can't set suspend",
      ...
      "updateOrderMessage": "Please contact the customer to confirm the change to the order.",
