const data = {
  ...
  delivery: {
    ...
    areaTextExample: "Kita-Aoyama 1-chome to 3-chome and Minami-Aoyama 1-chome to 7-chome, Minato City",
  ...
  admin: {
    ...
    order: {
      ...
      waitingPaymentWarninig: "This order cannot be accepted as payment has not been completed.",
    ...
    report: {
      ...
      "download-csv-all": "Download Excel File (Earnings)",
    ...
    totp: {
      ...
      signupWarning: {
        ...
        message: "Two-factor authentication can be set up from My Page after email verification. If the QR code is not displayed, please press 'Skip' to continue.",
      },
      error: {
