...
export const stripeCreateIntent = httpsCallable(functions, "stripeCreateIntent");
export const stripeConfirmIntent = httpsCallable(functions, "stripeConfirmIntent");
export const stripeCancelIntent = httpsCallable(functions, "stripeCancelIntent");
export const stripePaymentCancelIntent = httpsCallable(functions, "stripePaymentCancelIntent");
...
export const stripeUpdateCustomer = httpsCallable(functions, "stripeUpdateCustomer");
