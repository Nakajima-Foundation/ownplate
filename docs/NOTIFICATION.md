...
飲食店側で、メール、電話、LINE、Web Push の受信設定がそれぞれ必要です。
...
管理画面を閉じていても端末に通知が届きます。設定手順とハマりどころは
[WEBPUSH.md](./WEBPUSH.md) を参照してください。

- 管理画面の「通知設定」から端末ごとに ON/OFF する
- 店舗オーナーと、その店舗を担当するサブアカウントの両方に届く
- iOS は 16.4 以降かつ「ホーム画面に追加」した状態でのみ利用できる
