...
1. **アカウント作成**
   - おもちかえり.comの新規登録画面でメールアドレスとパスワードを入力
   - 「次へ」をクリック
...
すでにアカウントを持っている場合、マイページから二要素認証を有効化できます。
...
2. **二要素認証コードの入力画面が表示される**
   - スマートフォンで認証アプリを開く
   - おもちかえり.comのアカウントに表示されている6桁のコードを確認
   - 画面にコードを入力
...
二要素認証を無効化した後は、認証アプリからもおもちかえり.comのアカウントを削除できます。

- 認証アプリを開く
- おもちかえり.comのアカウントを長押し（またはタップ）
- 「削除」または「アカウントを削除」を選択
...
- **コードを他人に教えない**
  ...
  - おもちかえり.comのサポートがコードを尋ねることはありません
...
ご不明な点がございましたら、おもちかえり.comカスタマーサポートまでお問い合わせください。
