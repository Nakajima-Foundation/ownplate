...
export const resource_mo = {
  translation: {
    ...
    msg_stripe_payment_canceled: "決済処理が正しく完了できなかったため、カード決済を取り消しました。代金は受け取り時に店舗でお支払いください。" + suffix1 + "¥n※カード決済を対象とした割引キャンペーンが実施されている場合は、割引の対象外となりますのでご了承ください。
¥n※注文をキャンセルされたい場合はお手数ですが、注文店舗へ直接ご連絡いただきますようお願いします。", // mo
