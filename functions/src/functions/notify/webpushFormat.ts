...
export const createWebPushData = (title: string, body: string, url: string, tag: string): Record<string, string> => {
  return {
...
export const createOrderPushData = (subject: string, restaurantName: string, restaurantId: string, orderId: string) => {
  return createWebPushData(subject, restaurantName, adminOrderPath(restaurantId, orderId), orderId);
};
