...
describe("Order function", () => {
  it("Order function, orderCounter test", async () => {
    ...
    const orderData = {
      ...
      total: 1080,
      timePlaced: { seconds: 1614051000, nanoseconds: 756000000 },
      tax: 80,
      timeCreated: { seconds: 1613988203, nanoseconds: 388000000 },
      sendSMS: true,
      orderPlacedAt: { seconds: 1613988208, nanoseconds: 981000000 },
